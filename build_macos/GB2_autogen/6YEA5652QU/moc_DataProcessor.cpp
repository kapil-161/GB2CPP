...
void DataProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (DataProcessor::*)(const QString & )>(_a, &DataProcessor::dataProcessed, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (DataProcessor::*)(const QString & )>(_a, &DataProcessor::errorOccurred, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (DataProcessor::*)(int )>(_a, &DataProcessor::progressUpdate, 2))
            return;
    }
}
...
// SIGNAL 1
void DataProcessor::errorOccurred(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void DataProcessor::progressUpdate(int _t1)
{

...
public:
    ...
    void plotTimeSeries(
        ...
        const QMap<QString, QStringList> &yVarFileFilter = QMap<QString, QStringList>()
    );
...
private:
    ...
    QMap<QString, QStringList> m_yVarFileFilter;  // col → allowed source filenames; empty/absent = no filter

...
QString PlotWidget::getPlotRCode() const
{
    ...
    QString code = QString(
        ...
        "# Publication-ready figure (Field Crops Research / Eur J Agron style)\n"
        "# =================================================================\n\n"
        "library(ggplot2)\n"
        "library(tidyr)\n"
        "library(dplyr)\n\n"
        ...
        "# =================================================================\n"
        "# Style: Okabe-Ito colorblind-safe palette, linetypes, point shapes\n"
        "# Each treatment gets a unique color + linetype (sim) + shape (obs)\n"
        "# so figures remain interpretable in greyscale print.\n"
        "# =================================================================\n"
        ...
        "# Solid symbols for observed; vary shape for B&W distinguishability\n"
        "pt_shapes   <- c(16, 17, 15, 18, 1, 2, 0)\n"
        "trt_shapes  <- setNames(pt_shapes[seq_len(n_trt)], trt_levels)\n\n"
        "# --- Publication-ready theme (9 pt base, minimal grid) ---\n"
        "pub_theme <-\n"
        ...
        "  )\n\n"
        "# --- Variable labels for facet panels ---\n"
        "%11" // varLabelsBlock
        "# --- Plot ---\n"
        "# color + linetype = treatment (simulated lines)\n"
        "# color + shape    = treatment (observed symbols)\n"
        "# All three scales share name = \"Treatment\" -> merged into one legend\n"
        ...
        "  pub_theme\n\n"
        "# --- Save figure ---\n"
        "# Single column: fig_w = 85 mm  |  Double column: fig_w = 170 mm\n"
        "# Adjust fig_h to match journal column height requirements.\n"
        "fig_w <- 170  # mm\n"
        "fig_h <- %12  # mm -- auto-calculated from panel count\n\n"
